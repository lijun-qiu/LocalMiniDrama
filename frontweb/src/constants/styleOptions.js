...
export const generationStyleOptions = [
  {
    ...
    options: [
      ...
      { label: 'AI短剧',  value: 'ai short drama',
        prompt:   'AI数字人短剧风格，超写实影视质感，国产都市偶像剧柔肤布光，浅景深竖屏镜头，精致五官与细腻发质，高清无噪点，伪实拍短剧画面气质，甜宠豪门现言常见视觉',
        promptEn: 'AI digital human short drama style, hyperrealistic cinematic look, Chinese urban romance idol drama soft beauty lighting, shallow depth of field vertical framing, refined facial features and detailed hair, clean high-definition noise-free image, faux live-action micro-drama aesthetic, sweet romance and wealthy family drama visual tone',
        color: 'linear-gradient(135deg,#f4c4b0,#8b5a6b)', thumb: '/style-thumbs/ai-short-drama.jpg' },
